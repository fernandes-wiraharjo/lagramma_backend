...
@section('content')
    <!-- page title -->
    <x-breadcrumb title="Badges" pagetitle="Base UI" />
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex flex-wrap gap-2">
                                        ...
                                        <span class="badge text-bg-light text-body">Light</span>
                                    </div>
                                </div><!-- end card-body -->
                                ...
                                <div class="card-body">
                                    <pre class="language-markup" style="height: 175px;">
...
<code>&lt;span class=&quot;badge text-bg-light&quot;&gt;Light&lt;/span&gt;</code></pre>
                        ...
                        <div class="col-xxl-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <p class="text-muted">Use the <code>badge-soft-</code> class with the below-mentioned variation to create a softer badge. </p>
                                    <div class="d-flex flex-wrap gap-2">
...
<code>&lt;span class=&quot;badge bg-dark-subtle text-dark &quot;&gt;Dark&lt;/span&gt;</code>

<code>&lt;span class=&quot;badge bg-light-subtle text-light &quot;&gt;Light&lt;/span&gt;</code></pre>
                                </div>
                            </div><!-- end card -->
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-xxl-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <p class="text-muted">Use the <code>badge-outline-</code> class with the below-mentioned variation to create a badge with the outline. </p>
                                    <div class="d-flex flex-wrap gap-2">
                                        ...
                                        <span class="badge badge-outline-dark text-body">Dark</span>
                                        <span class="badge badge-outline-light text-body">Light</span>
                                    </div>
                                </div><!-- end card-body -->
                                <div class="card-body bg-light border-bottom border-top bg-opacity-25">
                                    <h5 class="fs-12 text-muted mb-0">HTML Preview</h5>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex flex-wrap gap-2">
                                        ...
                                        <span class="badge rounded-pill text-bg-dark text-body">Dark</span>
                                        <span class="badge rounded-pill text-bg-light text-body">Light</span>
                                    </div>
                                </div><!-- end card-body -->
                                <div class="card-body bg-light border-bottom border-top bg-opacity-25">
                                    <h5 class="fs-12 text-muted mb-0">HTML Preview</h5>
...
<code>&lt;span class=&quot;badge rounded-pill bg-dark-subtle text-dark &quot;&gt;Dark&lt;/span&gt;</code>

<code>&lt;span class=&quot;badge rounded-pill bg-light-subtle text-light &quot;&gt;Light&lt;/span&gt;</code></pre>
                                </div>
                            </div><!-- end card -->
                        </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex flex-wrap gap-2">
                                        ...
                                        <span class="badge bg-light-subtle badge-border text-body">Light</span>
                                    </div>
                                </div><!-- end card-body -->
                                <div class="card-body bg-light border-bottom border-top bg-opacity-25">
                                    <h5 class="fs-12 text-muted mb-0">HTML Preview</h5>
...
<code>&lt;span class=&quot;badge bg-dark-subtle text-dark  badge-border&quot;&gt;Dark&lt;/span&gt;</code>

<code>&lt;span class=&quot;badge bg-light-subtle text-light  badge-border&quot;&gt;Light&lt;/span&gt;</code></pre>
                                </div>
                            </div><!-- end card -->
                        </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex flex-wrap gap-2">
                                        ...
                                        <span class="badge rounded-pill badge-outline-dark text-body">Dark</span>
                                        <span class="badge rounded-pill badge-outline-light text-body">Light</span>
                                    </div>
                                </div><!-- end card-body -->
                                <div class="card-body bg-light border-bottom border-top bg-opacity-25">
                                    <h5 class="fs-12 text-muted mb-0">HTML Preview</h5>
