                        ...
                        <div class="card border-0 mb-0">
                            ...
                            <div class="card-body text-center">
                                ...
                                <p class="text-muted fs-15">
                                    Please enter the 4 digit code sent to <span class="fw-semibold">{{ session('otp_user_phone') }}</span>.
                                    The code is valid for a maximum of 5 minutes.
                                </p>

                                <div class="p-2">
                                    <form id="verify-otp-form" autocomplete="off" action="{{ route('login.otp.verify') }}" method="POST">
                                        @csrf
                                        <div class="row">
                                            <div class="col-3">
                                                <div class="mb-3">
                                ...
                                <div class="mt-4 text-center">
                                    <p class="mb-0">
                                        ...
                                        onclick="handleResendLoginOTP(event)"
                                        class="fw-semibold text-primary text-decoration-underline">
                                            Resend
                                        </a>
                                ...
                                <!-- <form id="resend-otp-form" action="{{ route('login.otp.resend') }}" method="POST" style="display: none;">
                                    @csrf
                                </form> -->
                            </div>
                        </div>
...
@endsection
@section('scripts')
    <script src="{{ URL::asset('build/js/pages/login-otp-verification.init.js') }}"></script>
@endsection
