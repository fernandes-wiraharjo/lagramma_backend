                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0 me-2 avatar-sm">
                                                        <div class="avatar-title bg-light rounded"> <img
                                                                src="{{ URL::asset('build/images/products/img-10.png') }}" alt=""
                                                                class="avatar-xs"> </div>
                                                    </div>
                                                    <div class="flex-grow-1">
                                        ...
                                        <tr>
                                            ...
                                            <td class="product_name">
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0 me-2 avatar-sm">
                                                        <div class="avatar-title bg-light rounded"> <img
                                                                src="{{ URL::asset('build/images/products/img-15.png') }}" alt=""
                                                                class="avatar-xs"> </div>
                                                    </div>
                                                    <div class="flex-grow-1">
                                                        <h6 class="mb-1"><a href="product-overview"
                                        ...
                                        <tr>
                                            ...
                                            <td class="product_name">
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0 me-2 avatar-sm">
                                                        <div class="avatar-title bg-light rounded"> <img
                                                                src="{{ URL::asset('build/images/products/img-1.png') }}" alt=""
                                                                class="avatar-xs"> </div>
                                                    </div>
                                                    <div class="flex-grow-1">
                                                        <h6 class="mb-1"><a href="product-overview"
                                        ...
                                        <tr>
                                            ...
                                            <td class="product_name">
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0 me-2 avatar-sm">
                                                        <div class="avatar-title bg-light rounded"> <img
                                                                src="{{ URL::asset('build/images/products/img-7.png') }}" alt=""
                                                                class="avatar-xs"> </div>
                                                    </div>
                                                    <div class="flex-grow-1">
                                                        <h6 class="mb-1"><a href="product-overview"
                                        ...
                                        <tr>
                                            ...
                                            <td class="product_name">
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0 me-2 avatar-sm">
                                                        <div class="avatar-title bg-light rounded"> <img
                                                                src="{{ URL::asset('build/images/products/img-4.png') }}" alt=""
                                                                class="avatar-xs"> </div>
                                                    </div>
                                                    <div class="flex-grow-1">
                                                        <h6 class="mb-1"><a href="product-overview"
                                        ...
                                        <tr>
                                            ...
                                            <td class="product_name">
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0 me-2 avatar-sm">
                                                        <div class="avatar-title bg-light rounded"> <img
                                                                src="{{ URL::asset('build/images/products/img-6.png') }}" alt=""
                                                                class="avatar-xs"> </div>
                                                    </div>
                                                    <div class="flex-grow-1">
                                                        <h6 class="mb-1"><a href="product-overview"
