...
@section('css')
    ...
    <style>
        .background-image {
            background-image: url("{{ URL::asset('build/images/assets/background-01.png') }}");
                        ...
                        <div class="col-lg-6">
                            <div class="auth-card mx-lg-3">
                                <div class="card border-0 mb-0 shadow-blur lagramma-auth-card">
                                    <div class="card-header d-flex p-0 lagramma-auth-card-header" style="border-top-left-radius: 20px; border-top-right-radius: 20px;">
